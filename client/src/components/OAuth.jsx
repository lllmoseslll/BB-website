...
export const OAuth = () => {
  ...
  return (
    <button
      type="button"
      className="flex justify-center gap-2 bg-transparent hover:bg-[#ff6c28]  font-semibold text-white py-2 px-4 border border-[#ff8828] hover:border-transparent rounded"
