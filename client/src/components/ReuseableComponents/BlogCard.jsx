...
export const BlogCard = (props) => {
  return (
    ...
    <img src={props.imageUrl} className="w-[100%] h-[70%] object-cover" alt="" />
    <div className=" flex justify-center flex-col text-white text-xl font-semibold">
      ...
      <button className="w-full border-4 border-[#ff8828] hover:bg-[#ff8828] rounded-xl p-2">Learn more &rArr; </button>
      </Link>
      </div>
  </div>
  )
