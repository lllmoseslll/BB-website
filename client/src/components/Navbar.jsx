...
const Navbar = () => {
  ...
  return (
    <>
      <div className="w-full text-[#ffffff] bg-black/20 flex justify-between items-center mx-auto px-3  h-[75px] fixed top-0  z-50 ">
        <div className="pl-6">
          <Link to="/">
            <svg
              className="w-[40px]"
        ...
        <div>
          <ul className=" font-semibold max-lg:hidden flex pr-[30%]">
            <li className="p-4 hover:cursor-pointer">
              <Link to="/home" active={path === "/"}>
                Home
              </Link>{" "}
            </li>
            <li className="p-4 hover:cursor-pointer">
              <Link to="/projects" active={path === "/projects"}>
                Projects
              </Link>{" "}
            </li>
            <li className="p-4 hover:cursor-pointer">
              <Link to="/about" active={path === "/about"}>
                About
              </Link>
            </li>
            <li className="p-4 hover:cursor-pointer">
              <Link to="/team" active={path === "/team"}>
                Team
              </Link>{" "}
            </li>
            <li className="p-4 hover:cursor-pointer">
              <Link to="/contact" active={path === "/contact"}>
                Contact
              </Link>{" "}
            </li>
            <li className="p-4 hover:cursor-pointer">
              <Link to="/blog" active={path === "/blog"}>
                Blog
              </Link>{" "}
            </li>
          </ul>
        ...
        <div className="flex gap-5">
          {currentUser ? (
            ...
            <Link to="/sign-in" active={path === "/sign-in"}>
              <Button outline gradientDuoTone="purpleToBlue" className=" ">
                Sign In
              </Button>
            </Link>
          )}
          ...
          <div
            className="hover:cursor-pointer lg:hidden flex justify-center items-center"
            onClick={handleNav}
          >
        ...
        <div
          className={
            !nav
              ? "z-40 fixed left-0 top-0 w-[60%] h-full border-r border-r-gray-400 bg-[#000000cc] "
              : "fixed left-[-100%]"
          }
        >
          <div className="p-6">
          ...
          <ul className="m-4 uppercase font-medium">
