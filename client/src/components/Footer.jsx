const Footer = () => {
  return (
    <>
      <footer className=" mt-auto brightness-75 bg-[#00000066] w-full  p-4 flex justify-center bottom-0  text-gray-400">
        <div>
          ...
          <div className="flex">
            <div className="px-2">
              ...
              >
                <path
                  d="M569.374 461.472V160.658H160.658v300.814h408.716z"
            ...
            <p className="text-[#e1dcdc]">bbarchitectects@gmail.com</p>
          </div>
          <div className="flex justify-center">
            <p className="text-[#e1dcdc] ">
              &copy;copyright 2024 BB Architects
            </p>
          </div>
        </div>
      </footer>
